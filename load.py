...
PROJECT_ID = 'airflow-working-429207'
PYSPARK_URI = 'gs://gcp_pipeline/code/transform.py'
...
CLUSTER_CONFIG = {
    ...
    "gce_cluster_config": {
        "zone_uri": "asia-southeast1-a",  # Changed from asia-southeast1-c to asia-southeast1-a
    },
}
...
with models.DAG(
    ...
    gsc_to_gbq = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table="airflow-working-429207.Airflow_Test.gcs_to_gbq_dataproc",
    ...
    create_dataset >> create_cluster >> submit_job >> [delete_cluster, gsc_to_gbq]